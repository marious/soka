<div class="flex flex-row sm:justify-end mb-3 px-4 sm:px-0 -mr-2 sm:-mr-3">
    ...
    >
        ...
        <span class="ml-2 hidden sm:inline whitespace-nowrap">{{ __('Reset') }}</span>
    </button>
